...
public class SarEmoCombi {
	public static void main(String args[])
	{
		...
		try
		{
			...
			{
				if(st1.equals("happy")&&st2.equals("angry"))
					System.out.println("yes sar");
				else if(st1.equals("happy")&&st2.equals("sad"))
					System.out.println("yes sar");
				else if(st1.equals("angry")&&st2.equals("happy"))
					System.out.println("yes sar");
				else if(st1.equals("sad")&&st2.equals("happy"))
					System.out.println("yes sar");
				else if(st1.equals("happy")&&st2.equals("disgust"))
					System.out.println("yes sar");
				else if(st1.equals("disgust")&&st2.equals("happy"))
					System.out.println("yes sar");
				else
